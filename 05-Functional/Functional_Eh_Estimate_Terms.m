function [Est_elewise_list,Est1_elewise_list,...
        ...
        post_term_1_elewise_list,post_term_2_elewise_list,post_term_3_elewise_list,post_term_4_elewise_list] ...
    ...
    if strcmp(func_type,'1')
        ...
        if strcmp(pde_ype,'1') % Poission
            ...
            % ||-grad(uh*)-q*||
            post_term_4_elewise_list = zeros(num_elements,1,numeric_t);
            ...
            for element_idx = 1: num_elements
                ...
                post_formua_4 = (-grad_uhstar_1 - q1_VD).^2 + (-grad_uhstar_2 - q2_VD ).^2;
                post_term_4_elewise_list(element_idx,1) = ...
                    Jk*GQ1DRef_wts'*(post_formua_4.*Jacobian_rs_to_ab )*GQ1DRef_wts;
