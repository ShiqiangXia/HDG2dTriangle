function Conv_matrix=Get_convolution_matrix(pts,kk,GQ1DRef_pts)

    % get 1/2 * sum_r C_r* A_{n,s,r,j}
    
    AA = PrecompBsplineGQ(kk,pts,GQ1DRef_pts);
    ...
    Conv_matrix = zeros(length(pts),NGQ,4*kk+1,numeric_t);
