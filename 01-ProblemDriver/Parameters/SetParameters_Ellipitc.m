function para = SetParameters_Ellipitc(varargin)
    ...
    pb_type,dom_type,...
    primal_data,adjoint_data,post_process_flag,err_cal_flag,tol_adp]...
    = MyParaParse(varargin,...
    'order','h0','Niter','refine_flag',...
    'pb_type','dom_type','primal','adjoint',...
    'post_process_flag','err_cal_flag','tol_adp');

    % define Parameter instance
    para = Parameter();
    ...
    precision = 'double';
    %precision = 'mp' ;
    GQ_deg = 8;  % need more quads for corner singularity case
