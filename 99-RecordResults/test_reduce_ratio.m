...
fprintf('--------- k = 1 --------------\n')
main('elliptic','order',1, 'h0',0.2, 'Niter',Niter_max, 'refine_flag', 1,...
    'pb_type',pb_type,'dom_type',dom_ype,'primal',0,'adjoint',0,...
    'post_process_flag',0,'err_cal_flag',1);

fprintf('--------- k = 2 --------------\n')
main('elliptic','order',2, 'h0',0.2, 'Niter',Niter_max, 'refine_flag', 1,...
    'pb_type',pb_type,'dom_type',dom_ype,'primal',0,'adjoint',0,...
    'post_process_flag',0,'err_cal_flag',1);

fprintf('--------- k = 3 --------------\n')
main('elliptic','order',3, 'h0',0.2, 'Niter',Niter_max, 'refine_flag', 1,...
    'pb_type',pb_type,'dom_type',dom_ype,'primal',0,'adjoint',0,...
    'post_process_flag',0,'err_cal_flag',1);
