function [lamh,uh_Neig,qh_Neig,uhat_Neig]...
      ...
      [lamh,uhat_Neig] = HDG_Eig_SolveEigenSystem(mymesh,k,...
      ...
      [qh_Neig,uh_Neig] = HDG_Eig_RecoverLovalVariable(mymesh,...
